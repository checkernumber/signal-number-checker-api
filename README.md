# Signal Number Checker API — official examples | CheckNumber

This repository documents the CheckNumber Signal Number Checker API integration contract using facts from the expansion manifest.

- Product page: https://checknumber.ai/products/signal
...
```bash
curl -X POST "https://api.checknumber.ai/v1/tasks" -H "X-API-Key: ${CHECKNUMBER_API_KEY}" -F "file=@examples/numbers.txt" -F "task_type=signal"
...
| --- | --- | --- | --- | --- | --- |
| `signal` | Number Checker | phone | 500–10000000 rows | `number, activated` | [docs](https://docs.checknumber.ai/signal-checker) |
...
- `signal`: https://docs.checknumber.ai/signal-checker
